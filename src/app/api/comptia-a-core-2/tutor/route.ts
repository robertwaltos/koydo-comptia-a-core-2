...
const EXAM_ID = "comptia-a-core-2";
const EXAM_DISPLAY_NAME = "CompTIA A+ Core 2 (220-1102)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover operating systems, security, software troubleshooting, and operational procedures. Align to CompTIA A+ Core 2 objectives.
