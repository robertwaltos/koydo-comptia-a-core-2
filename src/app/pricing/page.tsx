...
export const metadata: Metadata = {
  title: "Pricing — Comptia A Core 2 Premium",
  description: "Unlock unlimited Comptia A Core 2 practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=comptia-a-core-2&cadence=annual`;
