...
export const metadata: Metadata = {
  title: "Learn — CompTIA A+ Core 2 Practice",
  description: "Study and practice for CompTIA A+ Core 2. Choose your subject and start preparing.",
};
